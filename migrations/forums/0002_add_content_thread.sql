-- forums: schema version 0002, derived as the diff between what
...
ALTER TABLE "svc_forums".records ADD COLUMN IF NOT EXISTS "content" text;
ALTER TABLE "svc_forums".records ADD COLUMN IF NOT EXISTS "thread" text;
