...
ALTER TABLE "svc_tags".records ADD COLUMN IF NOT EXISTS "owner-only-access-control-on-update-and-delete" text;
ALTER TABLE "svc_tags".records ADD COLUMN IF NOT EXISTS "access_denied_response" text;
