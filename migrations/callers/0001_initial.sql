-- callers: initial schema, derived from the requirement (docs/11 §4).
--
...
CREATE SCHEMA IF NOT EXISTS "svc_callers";

CREATE SEQUENCE IF NOT EXISTS "svc_callers".record_id AS bigint START 1;

CREATE TABLE IF NOT EXISTS "svc_callers".records (
    "id" text PRIMARY KEY,
