-- users: initial schema, derived from the requirement (docs/11 §4).
--
...
CREATE SEQUENCE IF NOT EXISTS "svc_users".record_id AS bigint START 1;

CREATE TABLE IF NOT EXISTS "svc_users".records (
    "id" text PRIMARY KEY,
